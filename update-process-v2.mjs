{
  ...
  "generatedAt": "2026-07-23T21:49:26.091916Z",
  "sourceHash": "de74cb3ffbd0ee856b227c711a4f45e4f5b81c8a78f8a35e832a3d9988728828",
  "movements": [
    {
    ...
    },
    {
      ...
      "unit": "FAETEC/SECPRES",
      "description": "Conclusão do processo na unidade"
    },
    {
  ...
  "documents": [
    ...
    },
    {
      ...
      "excerpt": "",
      "excerptVersion": 3,
      "simpleExplanation": "Ofício novo da Presidência da FAETEC. O conteúdo ainda não está aberto, mas o processo foi encaminhado em seguida para a Assessoria Jurídica da SEEDUC."
    }
  ],
  "analysis": {
    "mode": "automatic",
    "phase": {
      "title": "Análise jurídica na SEEDUC",
      "explanation": "O processo saiu da Presidência da FAETEC e chegou à Assessoria Jurídica da Educação. A etapa pode avaliar o caminho legal e preparar novo despacho para gabinete, SEPLAG ou Casa Civil.",
      "nextSteps": [
        "Parecer ou despacho da ASSJUR",
        "Retorno para SEEDUC/GABSEC ou CHEGAB",
        "Envio para SEPLAG ou Casa Civil"
      ]
    },
    "result": "Melhorou juridicamente, mas a trava orçamentária continua.",
    "resultLevel": "warning",
    "summary": "A Presidência da FAETEC criou o Ofício NA 629, documento 137308944, em 23/07/2026. No mesmo dia, às 15:37, o processo saiu da FAETEC/PRESI e foi para a SEEDUC/ASSJUR. O texto do ofício ainda não está aberto ao público.",
    "practicalReading": "A FAETEC não segurou nem arquivou o processo: respondeu por ofício e devolveu a análise para a jurídica da Educação. Isso é avanço de tramitação, porque pode preparar parecer ou novo encaminhamento superior. Mas a falta de disponibilidade orçamentária registrada pela SUPOF em 13/07 continua sendo a principal trava.",
    ...
    "signals": [
      "A FAETEC se manifestou formalmente e o processo voltou para análise jurídica da SEEDUC, em vez de ficar parado na Presidência da fundação."
    ],
    "risks": [
      "O Ofício NA 629 ainda não está aberto e a falta de disponibilidade orçamentária continua registrada no processo."
    ],
  ...
  "history": [
    ...
    },
    {
      ...
      "text": "O registro público mais recente é de 23/07/2026 15:37, em SEEDUC/ASSJUR. O documento mais recente é 137308944, Ofício NA 629 da FAETEC/PRESI. Ainda não existe publicação definitiva do enquadramento."
    }
  ]
}
